...
app.locals.formatCurrency = value => (value === null || value === undefined || value === '') ? '—' : new Intl.NumberFormat('en-US', {
    style: 'currency',
    currency: 'USD'
}).format(Number(value));
...
app.use(app.locals.routePath('/tax-rates'), requireAuth, taxRateRoutes);
