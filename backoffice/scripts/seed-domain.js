...
async function run() {
  ...
  try {
    ...
    for (const d of demo) {
      ...
      const loc = await c.query(`INSERT INTO customer_locations(customer_id,property_type_id,address_line_1,city,state,postal_code,is_primary,access_notes) VALUES($1,$2,'123 Demo Street','Roswell','GA','30075',true,'Seeded location') RETURNING id`, [customerId, propertyType]);
